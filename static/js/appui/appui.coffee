class AppUI
  ...
  updateHomeVisibility:()->
    ...
    editorActive = @app.project? or /\/projects\/[^\/]+\/(code|sprites|maps|sounds|music|doc|assets|sync|options|publish|tabs)/.test(location.pathname)
    ...
    console.log "[home]", location.pathname, "project?", !!@app.project, "editor-active?", document.body.classList.contains("editor-active")
    return
