...
AppUI = class AppUI {
  ...
  backToProjectList(useraction) {
    ...
    return this.updateHomeVisibility();
  }
  ...
  setProject(project1, useraction = true) {
    ...
    this.doc_splitbar.initPosition(50);
    return this.updateHomeVisibility();
  }
  ...
  updateHomeVisibility() {
    var editorActive;
    // Check if editor is active: either project exists OR URL matches editor pattern
    editorActive = (this.app.project != null) || /\/projects\/[^\/]+\/(code|sprites|maps|sounds|music|doc|assets|sync|options|publish|tabs)/.test(location.pathname);
    if (editorActive) {
      document.body.classList.add("editor-active");
    } else {
      document.body.classList.remove("editor-active");
    }
    console.log("[home]", location.pathname, "project?", !!this.app.project, "editor-active?", document.body.classList.contains("editor-active"));
  }
