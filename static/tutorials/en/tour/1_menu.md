...
Digital House Game is an integrated game development environment.
...
* **Tutorials** : learn Digital House Game, programming, animation etc.
* **Documentation** : the full documentation of Digital House Game
* **About** : learn more about Digital House Game
...
Click "Tutorials": tutorials allow you to easily learn to use Digital House Game,
...
Click "Documentation": here you have access to the full documentation of Digital House Game and
...
Click "About" if you want to read more information on Digital House Game.
...
Click "Create" to start creating your first Digital House Game project! According to your preference,
