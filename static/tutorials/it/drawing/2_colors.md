...
In Digital House Game, un colore è dato come un valore stringa, che può essere conforme a diversi formati.
...
Digital House Game vi permette di omettere i colori in tutte le vostre chiamate di disegno. Quando omesso, riutilizzerà
...
Digital House Game accetta tutti i formati di colore HTML/CSS. Significa che puoi usare RGB hex (come ```"#FF00FF"```),
