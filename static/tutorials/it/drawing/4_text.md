...
Puoi disegnare del testo chiamando ```screen.drawText```. Poiché per disegnare il testo Digital House Game richiede che
...
Digital House Game include un set di simpatici font in stile bitmap. Per ottenere la lista completa:
...
* esegui questo demo che mostra tutti i font: https://Digital House Game.io/gilles/fonts/
