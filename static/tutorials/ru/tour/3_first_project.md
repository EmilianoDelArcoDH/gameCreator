...
Ваш первый проект уже создан! Вы создадите персонажа и запрограммируете Digital House Game для отображения его на экране и обеспечения возможности его перемещения по экрану с помощью клавиш со стрелками на клавиатуре вашего компьютера.
