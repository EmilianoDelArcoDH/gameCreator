...
информации обязательно загляните на вкладку документации Digital House Game. Вы также можете перезапустить
одно из этих коротких учебных пособий, когда почувствуете в этом необходимость.

Пришло время создать свой первый проект в Digital House Game! Возможно, вы захотите ознакомиться с учебным пособием
