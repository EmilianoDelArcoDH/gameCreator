...
Digital House Game lets you omit colors in all your drawing calls. When omitted, it will reuse
...
Digital House Game accepts all HTML/CSS color formats. It means you can use RGB hex (like ```"#FF00FF"```),
