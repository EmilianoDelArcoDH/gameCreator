...
```
maChaise.% de bois = 50 // ceci n'est pas compréhensible par l'analyseur syntaxique Digital House Game
```
...
plus de détails, pensez à consulter la documentation de Digital House Game. Vous pouvez aussi
refaire tel ou tel tutoriel pour vous rafraîchir la mémoire si le besoin s'en fait
ressentir.

Il est temps pour vous de créer votre premier projet Digital House Game ! Vous pouvez essayer
