...
Digital House Game est un environnement intégré de développement de jeux vidéo.
...
* **Tutoriels** : apprenez facilement Digital House Game, la programmation, l'animation etc.
* **Documentation** : la documentation complète de Digital House Game
* **A propos** : pour en savoir plus sur Digital House Game
...
à utiliser Digital House Game, à programmer en microScript, à dessiner à l'écran avec du code,
...
de Digital House Game et du langage de programmation microScript. Lorsque vous codez,
...
Cliquez sur "A Propos" si vous voulez en savoir plus sur Digital House Game !
...
Cliquez sur "Créer" pour commencer votre premier projet Digital House Game ! Selon votre
