...
programmer Digital House Game pour qu'il s'affiche à l'écran et se déplace avec les
...
constaterez qu'avec Digital House Game, les modifications sont instantanément reflétées dans la fenêtre
d'exécution.
