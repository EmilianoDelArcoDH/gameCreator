...
Vert et du Bleu. Ce système s'appelle le modèle de couleurs RVB comme Rouge, Vert, Bleu (en anglais RGB pour Red Green Blue). Dans Digital House Game, une couleur
...
Digital House Game vous autorise à omettre la couleur dans tous vos appels à des fonctions de dessin. Lorsqu'elle
...
Digital House Game accepte toutes les couleurs au format HTML/CSS. Cela signifie que vous pouvez utiliser
