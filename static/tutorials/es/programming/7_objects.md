...
Copy the code above. Puedes change the properties and add some to match your own chair.
...
Once you have created your object, Puedes access its properties as follows:
...
Copy the above example and see the result. Puedes also try other
properties.
...
Puedes change properties and set new ones to your chair object:
...
Puedes also access object properties by using brackets and a string value holding
...
Puedes set an object property to be a function:
...
Puedes iterate on the object properties with a ```for``` loop as follows:
...
make sure to look in the documentation tab of Digital House Game. You may also reLanza
