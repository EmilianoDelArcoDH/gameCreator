...
When you create sprites in the Sprites tab, Voc̻ pode set their name. This name will
...
"icon", which will serve as app icon. Voc̻ pode create more sprites in the Sprites tab
...
Animation tab at the bottom of the window. Voc̻ pode add frames, draw them, check the animation preview and set
the playback speed.
...
to the first frame. Voc̻ pode do this with:
...
Voc̻ pode choose to draw a specific animation frame of your sprite. For this Voc̻ pode append "." and the index
...
O seguinte code will draw the map "map1", centered on (0,0), with width 320 and height 200:
