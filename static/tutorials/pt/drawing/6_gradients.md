...
of another point p2. The next parameters are two Cores, defining the color the gradient will have at point p1 and the
...
The next parameters are two Cores, defining the color the gradient will have at the center and the
...
to check your arguments passed to setLinearGradient (expects two points and two Cores) and setRadialGradient (expects one point, a radius and two Cores).

Voc̻ pode then move on to the last tutorial in this series, about transparency, rotation and scaling.
