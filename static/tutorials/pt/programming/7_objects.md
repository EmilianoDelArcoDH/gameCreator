...
Objetos in microScript can be compared to Objetos in real life. An object is
...
Copy the code above. Voc̻ pode change the properties and add some to match your own chair.
...
Once you have created your object, Voc̻ pode access its properties as follows:
...
Copy the above example and see the result. Voc̻ pode also try other
properties.
...
Voc̻ pode change properties and set new ones to your chair object:
...
Voc̻ pode also access object properties by using brackets and a string value holding
...
Now we may "connect" our two Objetos:
...
Voc̻ pode set an object property to be a function:
...
Voc̻ pode iterate on the object properties with a ```for``` loop as follows:
...
make sure to look in the documentation tab of Digital House Game. You may also reInicie
one or the other of these shorts tutorials whenever you feel the need to.

It is time to build your first Digital House Game project! You may want to check the tutorial
