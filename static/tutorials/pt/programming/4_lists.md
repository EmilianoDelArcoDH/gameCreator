...
information in lists. The lists are modifiable (Voc̻ pode add elements to the list
...
Voc̻ pode add elements with the member function "push".
...
Voc̻ pode insert an item at the beginning of a list by using the member function "insert".
...
The items in a list are indexed starting from 0. Voc̻ pode then access
...
Voc̻ pode modify an item in the list by referencing it with its index:
...
Voc̻ pode remove an item from the list if you know its index:
