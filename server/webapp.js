...
this.WebApp = class WebApp {
  constructor(server, app) {
    ...
    this.home_page = {};
    // Language support: EN, PT, and ES
    this.languages = ["en", "pt", "es"];
    home_exp = "^(\\/";
    ...
    this.reserved = ["explore", "documentation", "projects", "create", "about", "login", "user", "tutorials\\/examples", "tutorials\\/community"];
    ...
    // Redirect root path to projects section (create project flow)
    this.app.get(/^\/$/, (req, res) => {
      return res.redirect(302, "/projects");
    });
    this.app.get(new RegExp(home_exp), (req, res) => {
      ...
      if (s[1] === "i") {
        ...
        this.home_page[lang] = this.home_funk({
          ...
          language_engines: this.concatenator.language_engines,
          translation: this.server.content.translator.languages[lang] != null ? this.server.content.translator.languages[lang].export() : "{}",
          title: "Digital House Game",
          description: translator.get("Digital House Game is a free, open source game engine, code centric, integrated, available in the cloud or offline."),
          long_description: translator.get("Digital House Game is a free, open source game engine, easy to learn and packed with features. It offers 4 programming languages and includes a sprite editor and a map editor."),
